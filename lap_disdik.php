...
include 'koneksi.php';
$data = mysqli_query($conn, " SELECT * FROM rekap_lra_disdik ");
...
$lra = mysqli_query($conn, " SELECT * FROM rekap_lra_disdik ");
...
$html =
    ...
    REKAPITULASI REALISASI ANGGARAN MANDATORY SPENDING-BIDANG PENDIDIKAN TA 2022</th>
    <th width=250px></th>
    </tr>
    </table>
    <br>
